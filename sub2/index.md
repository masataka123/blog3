...
- [教科書一覧](https://masataka123.github.io/blog3/pdf/20251001_masterguide/master_guide_20251001_C2.pdf)

私に近い分野や気になる分野の教科書をリストアップしました. 随時更新中です. 
...
- [公理的集合論と圏論まとめ(未完成)](https://masataka123.github.io/blog3/pdf/2025_02_18_set_category.pdf)

- [Condenced Mathmaticsまとめノート(未完成)](https://masataka123.github.io/blog3/pdf/2025_02_18_Condensed_Mathmatics_seminarnote.pdf)

2025年2月17日-21日開催の[Condensed mathematicsワークショップ](https://sites.google.com/view/condmathomu/home)の予習で必要になった知識のまとめです. 

- [超関数・カレントノート](https://masataka123.github.io/blog3/pdf/20251003_current_seminar/current_seminar_20260817.pdf)
...
- [Chern類と複素幾何学](https://masataka123.github.io/blog3/pdf/20260526_Tohoku_Chern_class/tohoku_2026_0526_ver2.pdf) 
...
- [Yauの定理とその応用](https://masataka123.github.io/blog3/pdf/20260813_Yau_theorem/Yau_theorem_application_2026_0818.pdf) 
...
# **chatGPTが書いたノート**
呑んだ勢いでchatGPTに修士論文を26本書いてもらいました. あってるか知らないので注意するしてください. 
...
またchatGPTに新規性・正しさ・修論や博論への妥当性を判断してもらった. [査読報告書](https://masataka123.github.io/blog3/pdf/20260908_chatGPT_paper/chatgpt_notes_full_review.pdf) 
修論への妥当性は私の修論を参考にしてもらった. 結果は"全て正しく修論レベルに達している"である. 
ただ博論へのレベルに達していないのは(つかのまの)安心である.
...
(2026/07/31 追記) 2026年1月に無事にHaidong Liuさん, Guplei Zhongさん, Niklas, Mullerさん含め親しい人を呼びまくった集会を開いた. Chenyang Xu先生も来たし結構でかい集会だった. 集会運営がかなり大変だったが, なかなか楽しかった.
...
(2024年9月以降)
その後劇的に変化があった. またNiklasが大活躍した. c2=0nu=1の構造定理ができたのである. しかもorbifoldを使うかなり独創的な方法で. これにはびっくりして, 松村さんと検証した. 
結果あっていて論文をMinimal projective varieties satisfying Miyaoka’s equalityと変更し出すことにした. 

Proceedings of the London Mathematical Society に掲載決定.
かなりいいところに掲載されたので自分でもびっくりした. (Donaldson-Uhlenbeck-YauのDonaldsonの論文がここに掲載されている)
あと個人的に一番好きな論文なので. 阪大の力を借りてオープンアクセスにしてもらった. 
...
上の論文長すぎたので二つに分けることにした. その二つ目である. 




- The Miyaoka-Yau inequality and the delta invariant for Fano varieties’
久本 智之さんとの共同研究である．久本さんとは初めての共同研究である. 

遡ること2025年12月の複素幾何シンポジウムでのこと. 久本さんがMiyaoka-Yau不等式に関する講演をした. それは「Donaldson 予想が成り立つならば, delta不変量を用いたMiyaoka-Yau不等式が成り立つ」といったものであった. 
この講演は正直言って私にとってはモヤモヤするものであった. すっきりとしない部分があった. 「絶対違うアプローチがあるはずだ」と思ったが当時はよくわからなかった.

そのご1月の阪大の集会中に「せっかくK stabilityの集会開いているし, K stabilityでも調べるか」と思い,上の問題を考えることにした. [Cao 13]を見てみると, どうもRic の下からのboundが知られていたら, minimal slopeが評価できることに気づいた. 「え？じゃあgreatesr Ricci lower boud使えばできんじゃないか？」と思い調べてみると, Tian 92ですでにcanoincal extension sheafのminimal slopeの評価はできていたのである. 

ここまでくるとsmoothの場合の証明はあっけないものである. Tian 92にLangerの不等式[lan04]を合わせるだけである. とりあえず久本さんに連絡した. 流石にこれでは結果にならないと思ったのでkltの場合に拡張することにした. 
ただアプローチは[DGP24]しかなく微分幾何学をやらないといけないことになった. 

ここからは気合いである. 2/4から気合いで[DGP24]を読むことにした. ちょっとでも詰まったらchatGPTに聴きまくって, 簡単なところ(Riemann curvature tensorの定義)から全て聞くことにした. 途中修論審査会があったが, ずっとipadで計算していた. 前にいた藤田さんに迷惑をかけた. 
一番苦労したのは2\piのずれが発生することである. DGP24はその部分かなり曖昧に書かれていた. これはsemistability を出すならそれで十分だが, slopeの評価を出すなら, 値をバッチリ出さないといけないので, 2\piを気にする必要がある. この部分もchatGPTに聴きまくった. chatGPTが記法のズレを直してくれた. 
気合いの結果2/18に, たった２週間で拡張できた.

と同時に久本さんがsolitonの場合のMiyaoka-Yauを提案してきた.
まあせっかくだし, kltだけだと面白くないので, これもやることにした. これはLangerの不等式の同変版を確立すれば終わりであることにすぐ気づいた. この辺り全くわからなかったが久本さんから「[HL26], [Inoue24]にヒントがあるかも」と教えてもらい, boucksom先生から「同変版のhodge index theoremはこのノート見たらわかるかも」と教えてもらった. 

ここから後も気合いである. 
気合いで[HL26], [Inoue24]を読んでcaltan modelを理解した. これもちょっとでも詰まったらchatGPTに聴きまくって, 簡単なところ(Lie微分の定義)から全て聞くことにした.ここは2/25に１週間くらいで理解できた. 
その後 boucksom先生のノートを見たら代数的な同変交点数の定義があった. Edidin-Grahamの論文にのっているようで  [Inoue24]にも引用されていた. 「え？Grothendieck-Riemann-Rochが同変でできてるんだったら, Langerの不等式も示せるかも」となった. 

なので気合いでEdidin-Grahamの論文[EG98]を読むことにした. これもchatGPTに聴きまくった. 
[HL26], [Inoue24], [EG98]を読んだ後自然と「これを全て合わせれば, 全部うまくいくんじゃないか？」と思い示していくことにした. するとSection 4以外の部分は全てうまくいった. この辺りもchatGPTと対話してできた部分である. この時点で3/22である. 今気づいたが１ヶ月しか経っていない. 

Section 4の内容, つまり多項式重みの部分はかなり悩まされた. chatGPTに聞いても「Quot scheme使えばいけるかも」というわからんこと言うし, そもそも[HL26 Subsection 3.6]の内容がよくわからなかった. この時点で疲れてきて, 3/23にできた部分を全てまとめて久本さんに送ることにした.
ちなみに全てまとめたpdfは88ページである. 

その後4月5月は授業の準備や学祭の準備に追われていたので, あまり何もやっていなかった. 
 6月はBando-SiuやSiuのレクチャーノートを読んでいた. (実はこれを読んでたおかげでSubsection 3.6を理解できるようになったのだが, 当時はそんなこと考えてなかった)
 その間に久本さんとBoucksom先生が解いてくれないかなーと思ったが解いてはくれなかった. 

6月の筑波の集会後, 久本さんから「論文を更新しました」との返信があった. 
それと同時に「もうこの研究終わらせるか」と思い多項式重みの部分を終わらせることにした. 
6/29以降, chatGPTと対話しまくって, [HL26 Subsection 3.6]のsemisimple fibrationを複素多様体として構成し直したら7/5にできた. 

飽きっぽいしマルチタスク苦手なので「この研究を早めに終わらせたほうがいい」と思い, 7/5以降土日返上朝５時からの作業を毎日行い, 気合いで論文をまとめていった. toric多様体知らなかったが, chatGPTに教えてもらって理解した. 
この論文はほとんどの部分を私が書いた. (というかこの論文, Subsection 7.2とAppendix B以外は私が全て書いた. ) 途中から私がやったほうが早いとわかり, イントロも久本さんが書いた部分( Subsection 7.2とAppendix B)もchatGPT使って私が修正・加筆することにした. Appendix Bの部分も確率論を使う部分の証明を書き直してもらうことにした. 気が狂う作業を7/5から7/19までやったところ, 論文は完成した. 

この研究, 久本さんやBoucksom先生よりchatGPTが遥かに活躍した研究である. もちろん彼らはchatGPTよりも偉いと思う. ただchatGPTはすぐに返信すると言う速さの点でかなり優れている. そしてアホな質問を含めて質問しまくれるのである. 偉い人に1回ずつ質問するより, chatGPTに何回も質問しまくる方が(少なくとも私にとっては)理解するには有益だった. 

しかも数学的な議論だとchatGPTなどAIの方が人間よりも厳密なのである. 久本さんが書いた４行の議論を「これは数学的な議論ではないです」とバッサリ切り捨てるし, 私が書いた部分を「これは議論が不足しています. 加筆するべきです」と言ってくるのである. 結果それらはほぼ全てあっていた. ちょっと怖くなった. 

あとどうでもいい部分に頭を使わなくて良くなったのもchatGPTの良い点である. 論文も日本語で読むようになった. 英語翻訳に脳を使わずに済むようになった. 「この議論は計算が難しいのか, それとも理論的に難しいのか？」と言う部分も一つずつ分解できるので, これもchatGPTの利点である. 


最近やったゲームは2つある. 
1つ目はぽこあぽけもんである. 3/23以降研究しなくなった原因である. 3/30に始めたらめちゃくちゃやってしまった. 仕事に支障が出るほどやっていた. いやーポケモンと過ごせるのいいですねえ. 生まれ変わったらポケモンになってポケモンと暮らしましょうかね.
2つ目はスプラトゥーン レイダースである. 7/19に研究を終わらせた理由の一つである. 論文のことを考えずにスプラをやりたかった. とりあえずエンディングは見たので, これから色々やっていこうかと思う. 
