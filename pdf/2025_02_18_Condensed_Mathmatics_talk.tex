...
\end{tcolorbox}
 ...
 \begin{tcolorbox}
 [colback = white, colframe = green!35!black, fonttitle = \bfseries,breakable = true]
\begin{thm}[点列極限としての右Kan拡張]\cite[10.3節]{Mac}
...
%(m,x) : Ob(c \downarrow K)$は
%$m \in Ob(M)$かつ$x : c \to Km$,
$m \in Ob(M)$とすると
