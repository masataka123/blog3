...
確定情報ではないので?マークをつけました. 
辻先生・高山先生の指導教官に関しては私が直接聞きました. \footnote{高山先生に「高山先生の指導教官って誰ですか？」と聞いたら, 偶然横にいた辻先生が「私ですね.」と言った. ただ高山先生が博士取得時に辻先生は東京都立大学にいなかったはずなので, (形式的な)指導教官は別かもしれません. 辻先生の指導教官に関しても辻先生に聞きました. なお大沢先生にも聞いたので, 多分正しいかなと思います. } 
%辻先生の指導教官は誰になるのだろうか? Siu先生な気もするが, これはわかりません. 
...
\node[person, align=center] at ($(xjapan) + (y1960) + (0,  0.5)$) (kodaira) {小平 \\ (1949)};
%Demailly
...
% 1970
%Ohsawa
\node[person, align=center] at ($(xjapan) + (y1970) + (0,-0.5)$) (miyaoka) {宮岡 \\ (1977)};
\draw[arrow] (kodaira) --  (miyaoka);
%Demailly
