...
\item 藤野修. 対数的極小モデル理論の最近の発展について 4章 極小モデル理論の勉強方法  \\ \url{https://www.math.kyoto-u.ac.jp/~fujino/kb-HP.pdf}
\end{itemize}
...
コメント: これも半分宣伝. $K$-安定性の代数的な事柄をまとめた本. この本を修士セミナーで読みたいのであれば, 私ではなく藤田先生のところで読むべきです. 私は読んでないです. 
 \vspace{8pt}
  ...
  \textbf{Phillip A. Griffiths. "Topics in Transcendental Algebraic Geometry" (Annals of Mathematics Studies, 106) Princeton Univ Press} \vspace{-6pt}

難易度：★★★$\sim$★★★★\vspace{-6pt} 

コメント: 「VHS(Variation of Hodge Structure)って何で勉強したらいいですかね？」と代数幾何学の人に聞いたらこれを教えてくれた. まだ読んでないけど確かに読みやすそうな気がする. 
 \vspace{8pt}
...
オンライン入手可能: \url{https://www-fourier.univ-grenoble-alpes.fr/~demailly/manuscripts/agbook.pdf}\vspace{-6pt}
...
オンライン入手可能: \url{https://www-fourier.univ-grenoble-alpes.fr/~demailly/manuscripts/analmeth_book.pdf}\vspace{-6pt}
...
後から気づいたが, あとで紹介する本"An Introduction to the Kähler-Ricci Flow"の3章の内容っぽい. 
\vspace{8pt}
...
コメント: 共同研究者のShiyu Zhangさんから教えてもらいました. 確かにKahler-Ricci flowをサラッと見るならこれでもいいかもしれないです. ちなみにShiyu Zhangさんはこの日本語のpdfをAI使って読んだらしいです. 最近のAIはすごいと思いました. 
\vspace{8pt}
...
オンライン入手可能: \url{https://www-fourier.univ-grenoble-alpes.fr/~demailly/manuscripts/estimations_l2.pdf}\vspace{-6pt}
...
この本を修士セミナーで読みたいのならば, 私ではなく山ノ井先生のところで読むべき. まあ私としては面白そうだから読んでほしいです. 最近(2025年現在), 山ノ井先生を含むYa Deng先生たちがすごい結果を確立していて, 活気のある分野でもあります. が, 私は全然フォローできてないです. 難しい.
\vspace{8pt}
...
コメント: 超平面配置がちょっと気になってます. 吉永先生におすすめの本を聞いたら上の二つを教えてくれました. Dimcaが新しめ, Orlik-Teraoは古いが今でも新規性のある内容を含んでいるとのことです. 
\vspace{8pt}
...
コメント: 「リーマン幾何学の教科書でいい本ありますか？」と阪大の幾何解析勢に聞いたら「うーん...」となって, 「Semi-Riemannian Geometryはいいと思うけど...」との返答がありました. 上の加須栄先生の本も勧めてくれました.

\vspace{8pt}

\textbf{本多 正平. "多様体の収束" 朝倉書店}  　\vspace{-6pt} 

難易度：★★★ $\sim$★★★★\vspace{-6pt} 

コメント: 田代先生に「RCD空間でなんか良い本ありますか？」と聞いたらこの本を勧めてくれた. 
Ambrosio-Gigli-Savareの仕事が云々と言っていた気がするが, 詳しいことを忘れてしまった. 
以下のサーベイ・論説に詳しいらしい. 
\begin{itemize}
\item 本多先生の日本数学会でのサーベイ \url{https://app.mathsoc.jp/meeting_data/okayama18sept/public/msjmeeting-2018sep-03i002.pdf}
\item 本多先生の論説 \url{https://www.jstage.jst.go.jp/article/sugaku/72/2/72_0722158/_pdf}
\end{itemize}


\vspace{8pt}

\textbf{桑江 一洋, 塩谷 隆, 太田 慎一, 高津 飛鳥, 桒田 和正. "最適輸送理論とリッチ曲率" 日本数学会}  　\vspace{-6pt} 

難易度：★★★ $\sim$★★★★\vspace{-6pt} 

オンライン入手可能: \url{https://www.mathsoc.jp/assets/pdf/publications/memoirs/sugaku-memoir-08.pdf}

コメント: この本なんだろうと思って田代先生に聞いたら, Cédric Villaniの1000ページくらいの内容がこの本でまとめられているとのこと. 
...
コメント: 確率論専門の人におすすめの教科書を聞いたら「この本は測度論が簡潔にまとまっているから読みやすいです」との返答がありました． 
