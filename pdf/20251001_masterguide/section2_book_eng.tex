...
\item Chapter 19 contains the material of Boucksom--Demailly--P\u{a}un--Peternell 13. It is related to Boucksom's Ph.D thesis. The result is interesting. The statement that $K_X$ is psef if and only if $X$ is nonuniruled is now known, by a result of Wenhao Ou in 2025, to hold also in the K\"ahler case.
\end{itemize}
...
\item Chapters 20 and 21 do not need to be read. However, the canonical metric of Professor Tsuji in Chapter 20 should have applications, for example in Song--Tian, and Chapter 21 may contain something interesting.
\end{itemize}
\vspace{8pt}
