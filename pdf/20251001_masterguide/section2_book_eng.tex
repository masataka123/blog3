...
\item Osamu Fujino. On recent developments in the log minimal model theory, Chapter 4: How to study minimal model theory. \\ \url{https://www.math.kyoto-u.ac.jp/~fujino/kb-HP.pdf}
\end{itemize}
...
Comment: It is a book that summarizes algebraic aspects of $K$-stability.
 ...
 \textbf{Phillip A. Griffiths, "Topics in Transcendental Algebraic Geometry" (Annals of Mathematics Studies, 106), Princeton University Press.} \vspace{-6pt}

Difficulty: ★★★$\sim$★★★★\vspace{-6pt}

Comment: When I asked an algebraic geometer, ``What is a good book for studying VHS (variation of Hodge structure)?'', they recommended this book to me. I have not read it yet, but it seems good.
\vspace{8pt}
...
\textbf{Nariya Kawazumi. "トポロジーの基礎 上・下" University of Tokyo Press (in Japanese)}  　\vspace{-6pt} 
...
\textbf{Shohei Honda. "多様体の収束" Asakura Publishing (in Japanese)} \vspace{-6pt}

Difficulty: ★★★ $\sim$ ★★★★ \vspace{-6pt}

Comment: When I asked Tashiro, a specialist in geometric analysis, whether there was a good book on RCD spaces, he recommended this one. I seem to recall that he mentioned the work of Ambrosio--Gigli--Savaré, but I have forgotten the details. The following survey articles apparently provide further information in Japanese:
\begin{itemize}
\item  \url{https://app.mathsoc.jp/meeting_data/okayama18sept/public/msjmeeting-2018sep-03i002.pdf}
\item \url{https://www.jstage.jst.go.jp/article/sugaku/72/2/72_0722158/_pdf}
\end{itemize}

\vspace{8pt}

\textbf{Kazuhiro Kuwae, Takashi Shioya, Shin-ichi Ohta, Asuka Takatsu, and Kazumasa Kuwada. "最適輸送理論とリッチ曲率". Mathematical Society of Japan (in Japanese)} \vspace{-6pt}

Difficulty: ★★★ $\sim$ ★★★★ \vspace{-6pt}

Available online: \url{https://www.mathsoc.jp/assets/pdf/publications/memoirs/sugaku-memoir-08.pdf}

Comment: I asked Tashiro about this book, and he told me that it summarizes the material covered in Cédric Villani's work.
