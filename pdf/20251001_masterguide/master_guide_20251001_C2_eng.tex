...
\title{List of textbook -Around Algebraic geometry, Complex geometry, and Several complex variables-} % タイトルとサブタイトル（改行＋スペースあり）
\author{Masataka Iwai} % 著者名は空白
\date{\today} % 今日の日付を表示
...
%\include{section1_field}
\include{section2_book_eng}
%\include{section3_master}
